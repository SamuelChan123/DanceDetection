const baseUrl = "https://eastus.api.cognitive.microsoft.com/customvision/";
const trainingUrlPart = "v3.0/training/projects/";
const predictionUrlPart = "v3.0/Prediction/";
...
const iterationName = findGetParameter("iterationName");
...
function predictFromImage(imageDataUrl) { //supports predict and play modes  
    $.ajax({
        url: baseUrl + predictionUrlPart + projectId + "/classify/iterations/" + iterationName + "/image",
        headers: {
